...
export interface ChatHistoryProps {
    ...
    isError: boolean
    /**
     * If greater than 0 the party selector should be shown and should allow the user to select up to the given number of parties.
     */
    maxNumberOfPartiesToSelect: number
    suggestions: string[]
    sendQuestion: (question: string) => void
}

export function ChatHistory(
    {messages, generationStatus, generatingAnswer, isError, maxNumberOfPartiesToSelect, suggestions, sendQuestion}: ChatHistoryProps
) {
    const intl = useIntl()
    const indicatorRef = useRef<HTMLDivElement>(null)
    const isGenerating = generationStatus !== "idle"
    const showPartySelector = maxNumberOfPartiesToSelect > 0
